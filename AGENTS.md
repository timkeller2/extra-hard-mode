...
That copies the remapped Extra Hard Mode jar to both local installs:

- `C:\Client\minecraftserver\mods`
- `C:\Users\tim\AppData\Roaming\.minecraft\mods`

Copy only the Extra Hard Mode jar, not the sources jar. Replace any previous `extrahardmode-*.jar` in those folders.
