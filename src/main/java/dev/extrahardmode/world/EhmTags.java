...
public final class EhmTags {
    public static final TagKey<Block> SOFT_TORCH_SURFACES = block("soft_torch_surfaces");
    public static final TagKey<Block> DEPTH_LIMITED_LIGHTS = block("depth_limited_lights");
    ...
    public static final TagKey<Biome> DESERT_INFERTILE = biome("desert_infertile");
