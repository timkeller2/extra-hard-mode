...
public final class EhmHelp {
    ...
    public static List<String> featureHelpLines() {
        return List.of(
                ...
                "Mana: Cyan crystals. You regen over time; quartz in your inventory speeds it until you reach your mana level. Past your level you regen at 1/4 speed, up to 20 mana (10 crystals). Achievements can raise your mana level.",
